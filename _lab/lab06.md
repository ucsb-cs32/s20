...
* If you choose to work with a partner for thi lab:
...
In this step, we are going to copy the {{page.num}} starter files from the given directory into your <tt>/cs32/{{page.num}}</tt> directory.
